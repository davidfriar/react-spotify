...
export interface components {
  schemas: {
    ...
    PlayHistoryObject: {
      ...
      track?: components["schemas"]["SimplifiedTrackObject"];
      /**
       * Format: date-time
    ...
    RecommendationSeedObject: {
      ...
      /** @description A link to the full track or artist data for this seed. For tracks this will be a link to a [Track Object](/documentation/web-api/reference/#object-trackobject). For artists a link to [an Artist Object](/documentation/web-api/reference/#object-artistobject). For genre seeds, this value will be `null`. */
      href?: string;
    ...
    PlaylistObject: {
      ...
      tracks?: components["schemas"]["PlaylistTracksPagingObject"];
    ...
    AlbumsPagingObject: components["schemas"]["PagingObject"] & {
      items?: components["schemas"]["SimplifiedAlbumObject"][];
    };
    ArtistsPagingObject: components["schemas"]["PagingObject"] & {
      items?: components["schemas"]["ArtistObject"][];
    };
    EpisodesPagingObject: components["schemas"]["PagingObject"] & {
      items?: components["schemas"]["SimplifiedEpisodeObject"][];
    };
    PlaylistTracksPagingObject: components["schemas"]["PagingObject"] & {
      items?: components["schemas"]["PlaylistTrackObject"][];
    };
    PlaylistsPagingObject: components["schemas"]["PagingObject"] & {
      items?: components["schemas"]["SimplifiedPlaylistObject"][];
    };
    ShowsPagingObject: components["schemas"]["PagingObject"] & {
      items?: components["schemas"]["SimplifiedShowObject"][];
    };
    SimplifiedArtistsPagingObject: components["schemas"]["PagingObject"] & {
      items?: components["schemas"]["SimplifiedArtistObject"][];
    };
    SimplifiedTracksPagingObject: components["schemas"]["PagingObject"] & {
      items?: components["schemas"]["SimplifiedTrackObject"][];
    };
    TracksPagingObject: components["schemas"]["PagingObject"] & {
  ...
  responses: {
    ...
    CursorPagedArtists: {
      content: {
        "application/json": {
          artists: components["schemas"]["CursorPagingObject"] & {
            items?: components["schemas"]["ArtistObject"][];
          };
        };
      };
    };
    /** A paged set of objects */
    CursorPaging: {
      content: {
        "application/json": components["schemas"]["CursorPagingObject"];
      };
    };
    /** A set of artists */
    ManyArtists: {
    ...
    AlbumsPagingObject: {
      content: {
        "application/json": components["schemas"]["AlbumsPagingObject"];
      };
    };
    /** Pages of artists */
    ArtistsPagingObject: {
      content: {
        "application/json": components["schemas"]["ArtistsPagingObject"];
      };
    };
    /** Pages of episodes */
    EpisodesPagingObject: {
      content: {
        "application/json": components["schemas"]["EpisodesPagingObject"];
      };
    };
    /** Pages of PlayHistory objects */
    ...
    /** Pages of playlist tracks */
    PlaylistTracksPagingObject: {
      content: {
        "application/json": components["schemas"]["PlaylistTracksPagingObject"];
      };
    };
    /** Pages of playlists */
    PlaylistsPagingObject: {
      content: {
        "application/json": components["schemas"]["PlaylistsPagingObject"];
      };
    };
    /** Pages of saved albums */
    SavedAlbumsPagingObject: {
      content: {
        "application/json": components["schemas"]["PagingObject"] & {
    ...
    /** Pages of saved episodes */
    SavedEpisodesPagingObject: {
      content: {
        "application/json": components["schemas"]["PagingObject"] & {
    ...
    /** Pages of saved shows */
    SavedShowsPagingObject: {
      content: {
        "application/json": components["schemas"]["PagingObject"] & {
    ...
    /** Pages of saved tracks */
    SavedTracksPagingObject: {
      content: {
        "application/json": components["schemas"]["PagingObject"] & {
    ...
    SimplifiedArtistsPagingObject: {
      content: {
        "application/json": components["schemas"]["SimplifiedArtistsPagingObject"];
      };
    };
    /** Pages of tracks */
    SimplifiedTracksPagingObject: {
      content: {
        "application/json": components["schemas"]["SimplifiedTracksPagingObject"];
      };
    };
    /** Pages of tracks */
    TracksPagingObject: {
      content: {
        "application/json": components["schemas"]["TracksPagingObject"];
      };
    };
  };
  parameters: {
...
export interface operations {
  ...
  "get-an-albums-tracks": {
    ...
    responses: {
      200: components["responses"]["SimplifiedTracksPagingObject"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
  ...
  "get-an-artists-albums": {
    ...
    responses: {
      200: components["responses"]["AlbumsPagingObject"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
  ...
  "get-a-shows-episodes": {
    ...
    responses: {
      200: components["responses"]["EpisodesPagingObject"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
  ...
  "get-playlists-tracks": {
    ...
    responses: {
      200: components["responses"]["PlaylistTracksPagingObject"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
  ...
  "get-a-list-of-current-users-playlists": {
    ...
    responses: {
      200: components["responses"]["PlaylistsPagingObject"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
  ...
  "get-users-saved-albums": {
    ...
    responses: {
      200: components["responses"]["SavedAlbumsPagingObject"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
  ...
  "get-users-saved-tracks": {
    ...
    responses: {
      200: components["responses"]["SavedTracksPagingObject"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
  ...
  "get-users-saved-episodes": {
    ...
    responses: {
      200: components["responses"]["SavedEpisodesPagingObject"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
  ...
  "get-users-saved-shows": {
    ...
    responses: {
      200: components["responses"]["SavedShowsPagingObject"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
  ...
  "get-featured-playlists": {
    ...
    responses: {
      200: components["responses"]["PagedPlaylistsAndMessage"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
  ...
  "get-recently-played": {
    ...
    responses: {
      200: components["responses"]["PlayHistoryCursorPagingObject"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
  ...
  "get-users-top-artists": {
    ...
    responses: {
      200: components["responses"]["ArtistsPagingObject"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
  ...
  "get-users-top-tracks": {
    ...
    responses: {
      200: components["responses"]["TracksPagingObject"];
      401: components["responses"]["Unauthorized"];
      403: components["responses"]["Forbidden"];
      429: components["responses"]["TooManyRequests"];
    };
